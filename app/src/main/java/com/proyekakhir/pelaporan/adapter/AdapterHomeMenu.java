...
public class AdapterHomeMenu extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<HomeMenu> items = new ArrayList<>();

    private Context ctx;
    private OnItemClickListener mOnItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(View view, HomeMenu obj, int position);
    }
    ...
    public AdapterHomeMenu(Context context, List<HomeMenu> items) {
        this.items = items;
        ctx = context;
    }
